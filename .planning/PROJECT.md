...
| Frontend toolchain deferred until n11 recon | Picking Vite-vs-Next-vs-CRA blind is silly — once we see how dynamic n11's grid/PDP are, we'll know if SSR helps. Recon → decide | — Pending |
