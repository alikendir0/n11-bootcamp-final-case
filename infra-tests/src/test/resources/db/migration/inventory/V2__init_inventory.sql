-- V2__init_inventory.sql (infra-tests inventory copy for PaymentFailureCompensationE2ETest)
-- Mirrors inventory-service/src/main/resources/db/migration/V2__init_inventory.sql.
-- The V3 stock seed is intentionally NOT mirrored — the test seeds its own stock rows.
