-- V2__init_orders.sql (infra-tests orders copy for PaymentFailureCompensationE2ETest)
-- Mirrors order-service/src/main/resources/db/migration/V2__init_orders.sql.
